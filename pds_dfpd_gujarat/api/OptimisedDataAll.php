...
?>
 ...
 <style>
                                    ...
                                    <table id="export_table" class="table">
                                        <thead>
                                            <tr>
												...
												<th style="font-size:16px">DCP</th>
										...
										while($row = mysqli_fetch_assoc($result))
										{
											...
											if($numrows_leg1>0){
												...
												echo "<tr><td>{$row['year']}</td>".
												 ...
												 "<td> <button class='btn btn-success btn-rounded' onclick=\"dcp_open('{$temp_id}','{$id_leg1}')\">View DCP</button></td>".
    ...
    <!-- START SCRIPTS -->
		...
		function dcp_open(temp_id, leg_id){
			post({id:temp_id,step:"all",legid:leg_id} ,"DCPView.php");
		}

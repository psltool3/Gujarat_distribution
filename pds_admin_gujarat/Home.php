		...
		<div class="col-md-12">
			...
			<div class="panel panel-default">
				<div class="panel-heading" style="text-align: center;">
					...
					<h1 style="font-weight: bold; color: #FF6666;">Kindly Optimise Leg2-Warehouse to FPS</h1>
...
function showCheckboxes() {
  ...
  if (!expanded) {
        ...
        $.ajax({
            ...
            success: function(response) {
                ...
                try {
                    ...
                    var displayMessage = (typeof res.message === "object") ? JSON.stringify(res.message) : res.message;
                    if (res.status === "success") {
                        alert("Data successfully pushed to Annachakra API!\nResponse: " + displayMessage);
                    } else {
    ...
    function checkActiveJob() {
        ...
        fetch(pythonUrl + 'active_job?client_id=' + encodeURIComponent(username) + '&endpoint=' + encodeURIComponent('/processFile'))
            .then(response => response.json())
            .then(data => {
                if (data.status == 1 && data.job) {
                    window.isJobRunning = true;

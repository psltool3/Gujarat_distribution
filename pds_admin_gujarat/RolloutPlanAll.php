                                    ...
                                    <table id="export_table" class="table" >
                                        <thead>
                                            <tr>												
												...
												<th style="font-size:16px">From_Block</th>
												...
												<th style="font-size:16px">To_Block</th>
			...
			$.ajax({
				...
				success: function(result){
					...
					try{
						...
						cell2.innerHTML = "2,13,803";
						cell3.innerHTML = "5,43,905";
						cell4.innerHTML = "6,03,12,569";
						cell5.innerHTML = "28.27";
						cell6.innerHTML = "";

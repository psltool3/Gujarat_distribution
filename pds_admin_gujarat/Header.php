...
<html lang="en">
    <head>
		...
		<!-- <script> var pythonUrl = "https://gujpds-ro.in/api/"; var directory = "" </script> -->
    ...
    <body>
        ...
        <div class="page-sidebar">
			...
			<ul class="x-navigation">
				<li class="xn-logo">
					<span style="font-size: 19px; text-align: center; margin: 10px;color:#fff">Gujarat State </span>
				...
				<li>
					<a href="Manual.pdf" download>
						...
						<span class="xn-text" style="font-family:sans-serif;font-style:italic;font-size:18px;">
							Manual
						</span>
					</a>
				</li>
